...
export const GATE_REGISTRY: Record<GateName, GateDef> = {
  ...
  U: {
    ...
    cirq: (qb, p) => `# decompor: rz(${fmtNum(p[1])}) . ry(${fmtNum(p[0])}) . rz(${fmtNum(p[2])}) + fase global`,
  },
  CX: {
    name: 'CX', kind: 'controlled', numQubits: 2, numControls: 1, numParams: 0, group: '2-QUBIT',
    matrix: () => X_MAT, matrixLabel: 'CNOT, controle q0',
  ...
  CY: {
    ...
    matrix: () => Y_MAT, matrixLabel: 'Y controlado',
  ...
  CZ: {
    ...
    matrix: () => Z_MAT, matrixLabel: 'Z controlado',
  ...
  CH: {
    ...
    matrix: () => H_MAT, matrixLabel: 'H controlado',
  ...
  SWAP: {
    ...
    matrix: () => X_MAT, matrixLabel: 'troca',
  ...
  CP: {
    ...
    matrix: (p) => P_MAT(p[0]), matrixLabel: 'fase controlada',
  ...
  CRX: {
    ...
    matrix: (p) => RX_MAT(p[0]), matrixLabel: 'RX controlado',
  ...
  CRY: {
    ...
    matrix: (p) => RY_MAT(p[0]), matrixLabel: 'RY controlado',
  ...
  CRZ: {
    ...
    matrix: (p) => RZ_MAT(p[0]), matrixLabel: 'RZ controlado',
